...
const Navbar = () => {
    ...
    useEffect(() => {
        const checkAuthStatus = async () => {
            try {
                await axios.get('https://libarylane-server.onrender.com/auth/check-auth', { withCredentials: true });
    ...
    const handleLogout = async () => {
        try {
            await axios.get('https://libarylane-server.onrender.com/user/logout', { withCredentials: true });
            setIsAuthenticated(false);
            navigate("/login");
